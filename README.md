# Welcome to my Dashboarding/Recommendation Engine Repo
As someone in the pharmaceutical analytics space, I probably should have a dashboarding project somewhere here.
We will also incorporate some machine learning once we model the data! This project is a **work in progress**, please forgive some syntaxical issues. 
My goal is to finish in late July/early August, so if you are plotting a time to revisit here, that would be the time. Else, you can enjoy my brainstorming
